...
namespace DoubleDoubleDistributionTest.ContinuousDistribution {
    ...
    public class FisherZDistributionTests {
        readonly FisherZDistribution dist_d1_1_d2_1 = new(d1: 1, d2: 1);
        readonly FisherZDistribution dist_d1_2_d2_1 = new(d1: 2, d2: 1);
        readonly FisherZDistribution dist_d1_1_d2_2 = new(d1: 1, d2: 2);
        readonly FisherZDistribution dist_d1_2_d2_2 = new(d1: 2, d2: 2);
        readonly FisherZDistribution dist_d1_3_d2_4 = new(d1: 3, d2: 4);
        readonly FisherZDistribution dist_d1_4_d2_2 = new(d1: 4, d2: 2);
        readonly FisherZDistribution dist_d1_2_d2_4 = new(d1: 2, d2: 4);
        readonly FisherZDistribution dist_d1_4_d2_4 = new(d1: 4, d2: 4);
        readonly FisherZDistribution dist_d1_6_d2_8 = new(d1: 6, d2: 8);
        readonly FisherZDistribution dist_d1_8_d2_6 = new(d1: 8, d2: 6);
        readonly FisherZDistribution dist_d1_8_d2_8 = new(d1: 8, d2: 8);
        readonly FisherZDistribution dist_d1_10_d2_10 = new(d1: 10, d2: 10);

        FisherZDistribution[] Dists => new[]{
            dist_d1_1_d2_1,
            dist_d1_2_d2_1,
            dist_d1_1_d2_2,
            dist_d1_2_d2_2,
