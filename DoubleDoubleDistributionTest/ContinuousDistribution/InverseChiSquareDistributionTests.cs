...
namespace DoubleDoubleDistributionTest.ContinuousDistribution {
    ...
    public class InverseChiSquareDistributionTests {
        readonly InverseChiSquareDistribution dist_nu1 = new(k: 1);
        readonly InverseChiSquareDistribution dist_nu2 = new(k: 2);
        readonly InverseChiSquareDistribution dist_nu3 = new(k: 3);
        readonly InverseChiSquareDistribution dist_nu4 = new(k: 4);
        readonly InverseChiSquareDistribution dist_nu5 = new(k: 5);
        readonly InverseChiSquareDistribution dist_nu8 = new(k: 8);
        readonly InverseChiSquareDistribution dist_nu16 = new(k: 16);
        readonly InverseChiSquareDistribution dist_nu32 = new(k: 32);
        readonly InverseChiSquareDistribution dist_nu64 = new(k: 64);
        readonly InverseChiSquareDistribution dist_nu128 = new(k: 128);


        InverseChiSquareDistribution[] Dists => new[]{
            dist_nu1,
            dist_nu2,
            dist_nu3,
            dist_nu4,
