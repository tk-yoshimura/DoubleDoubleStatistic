...
namespace DoubleDoubleStatistic {
    public class ArgusDistribution : ContinuousDistribution {
        ...
        public override ddouble Mode => Sqrt((alpha_sq - 2) + Sqrt(alpha_sq * alpha_sq + 4d)) / (Sqrt2 * Alpha);

        public override ddouble Variance => (1 - 3d / alpha_sq + Alpha * Exp(-alpha_sq * 0.5d) / Sqrt(2d * PI) * psi_inv) - Square(Mean);
