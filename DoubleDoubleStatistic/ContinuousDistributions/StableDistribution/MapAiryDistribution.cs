...
namespace DoubleDoubleStatistic.ContinuousDistributions {
    ...
    public class MapAiryDistribution : StableDistribution<MapAiryDistribution>,
        ...
        public static (MapAiryDistribution? dist, ddouble error) Fit(IEnumerable<double> samples, (double min, double max) fitting_quantile_range, int quantile_partitions = 100)
            => Fit(samples.Select(v => (ddouble)v), fitting_quantile_range, quantile_partitions);

        public static (MapAiryDistribution? dist, ddouble error) Fit(IEnumerable<ddouble> samples, (ddouble min, ddouble max) fitting_quantile_range, int quantile_partitions = 100) {
            return QuantileLinearFitter<MapAiryDistribution>.Fit(new MapAiryDistribution(), samples, fitting_quantile_range, quantile_partitions);
        }
        ...
        public override string Formula => "p(x; mu, c) := stable_distribution(x; alpha = 3/2, beta = 1, mu, c)";
        ...
        private static class CDFPade {
            ...
            private static readonly ReadOnlyCollection<(ddouble c, ddouble d)> pade_minus_2_4 = new(Array.AsReadOnly(new (ddouble c, ddouble)[]{
                ((+1, -1, 0xD4F1496B068C9604uL, 0x8E1BADDFD7CA0F89uL), (+1, 0, 0x8000000000000000uL, 0x0000000000000000uL)),
                ((+1, 1, 0x8E909961F5260878uL, 0xF997A26A50B66DF1uL), (+1, 1, 0x96ECD47260580995uL, 0xDAAB904A5E03EE40uL)),
                ((+1, 1, 0xACBF9EB1D763FADEuL, 0x21AEEC54CD4FE1C1uL), (+1, 1, 0xA6F50E393BE5ED15uL, 0xCF1FDC79C756B1B0uL)),
                ((+1, 0, 0xFF6C89FF0CE4EA96uL, 0x2BDA41693C698F04uL), (+1, 0, 0xE92137575EDC4D4CuL, 0xE09FE63AAAA1BD03uL)),
                ((+1, 0, 0x833634FC00B4DCD9uL, 0x14FB12A1F50EFB82uL), (+1, -1, 0xE798A49E49DACD97uL, 0x51EF166FA91BB4B6uL)),
                ((+1, -2, 0xC9315C35B4B6C44AuL, 0x81F9965B3FF91654uL), (+1, -2, 0xADE8015B5DA79410uL, 0x8896FDE4ECA9B17BuL)),
                ((+1, -4, 0xEF413424D32A9F13uL, 0xB1F428A2B6DD2C1CuL), (+1, -4, 0xCC0AFB9096C9985DuL, 0xDD708C0C594388FFuL)),
                ((+1, -6, 0xE0E6ACECB6E5C12FuL, 0xD7777FF0D36A0204uL), (+1, -6, 0xBE2C2C8B41D2A0CBuL, 0x74BABBEDEA1086C3uL)),
                ((+1, -8, 0xA831B8FA2B22FD32uL, 0x9E10DF33FCBEC29BuL), (+1, -8, 0x8D6D6F62DCFB9B19uL, 0x79F98D189C82DD39uL)),
                ((+1, -11, 0xC6E5C22D4EECE7E2uL, 0x0B16F97B146CCA83uL), (+1, -11, 0xA6ABF44696E2F716uL, 0x50DB21CB3595B8D8uL)),
                ((+1, -14, 0xB620C954EFB1E209uL, 0xF46B791A57FEEFBCuL), (+1, -14, 0x9850D04EDBC225A4uL, 0x22B6A4ECA9E931FDuL)),
                ((+1, -18, 0xF71DCFA7625E3A9AuL, 0xC019251ED2BFA3F0uL), (+1, -18, 0xCE7A46FD0926E891uL, 0x04A837C8AF7A4741uL)),
                ((+1, -22, 0xE1EE61DA2743012CuL, 0x956AC51A21B8B7C8uL), (+1, -22, 0xBCC6455AEE423DC7uL, 0xAA66C90CF7E6040FuL)),
                ((+1, -27, 0xD99739BD3061820EuL, 0xE3E75EE73278FD64uL), (+1, -27, 0xB5CE833540F84030uL, 0x6DC3751ED0D7C61EuL)),
            }));

            private static readonly ReadOnlyCollection<(ddouble c, ddouble d)> pade_minus_4_8 = new(Array.AsReadOnly(new (ddouble c, ddouble)[]{
                ((+1, 0, 0x8D2D5192B6EA3F54uL, 0xD42C605DACF4FB7FuL), (+1, 0, 0x8000000000000000uL, 0x0000000000000000uL)),
                ((+1, 1, 0x83E60AAD1B727829uL, 0xBCF832B4F34884F9uL), (+1, 0, 0xE891AAA77EDB4263uL, 0xE903D3CE8AC761D4uL)),
                ((+1, 0, 0xEB5F50CB1AFDB7A0uL, 0x7C310773AA942FCBuL), (+1, 0, 0xCBD7EECA2C0FCF37uL, 0xF6200243E9DB8651uL)),
                ((+1, 0, 0x853BDF3FB7A19052uL, 0x2E0450616E96A872uL), (+1, -1, 0xE41506F216872744uL, 0x486044C4C8CE5C1FuL)),
                ((+1, -2, 0xD5E9C20C86646431uL, 0x84A7D1AE43AC534BuL), (+1, -2, 0xB5A39FC83DD9A7FDuL, 0x3B96D5D96C0ECB0FuL)),
                ((+1, -3, 0x80B99BD2630231FEuL, 0x88A4A78BACFC1A49uL), (+1, -4, 0xD9651C0383813F13uL, 0x70313E397086AE77uL)),
                ((+1, -6, 0xEF2BE624D3A513D3uL, 0x2FCE9D5D4BF50C97uL), (+1, -6, 0xC92CCF0600508DB4uL, 0xA7A0572875873E4CuL)),
                ((+1, -8, 0xADD325FA138B7FA3uL, 0xAAD52B1A1CF39172uL), (+1, -8, 0x91D0608054E09CC1uL, 0x7D2C5C21DB8699FBuL)),
                ((+1, -11, 0xC5E7E63B9B3B186BuL, 0x8596C56ED20F9F0FuL), (+1, -11, 0xA5B5A89926653858uL, 0x3255CA824A1D318EuL)),
                ((+1, -14, 0xAE959D7C66AE543BuL, 0xAB97D5EE3C96B710uL), (+1, -14, 0x920295D6DBEFA3D5uL, 0x2DCC54828076EE1CuL)),
                ((+1, -18, 0xE8740F2299EF996DuL, 0x3363428626D30F84uL), (+1, -18, 0xC24733A6B271ED38uL, 0xD7B78E678C1BBDE2uL)),
                ((+1, -22, 0xDDC964C08D99FDF2uL, 0xD20306C310B26338uL), (+1, -22, 0xB94FF0B1AC2419B7uL, 0xECF68F9AF7547D16uL)),
                ((+1, -26, 0x886A2F2DCAE5F04FuL, 0x183C595331C28BC4uL), (+1, -27, 0xE3F5F4C9D30E86D7uL, 0x0A0067C96D9668B7uL)),
                ((+1, -32, 0xA44C6F7B38B49298uL, 0xB3262AB838142905uL), (+1, -32, 0x89474AD884B2A0DBuL, 0x0082710798C718F3uL)),
                ((+1, -67, 0x90747AA2C8A29511uL, 0x900566CCD3690473uL), Zero),
            }));

            private static readonly ReadOnlyCollection<(ddouble c, ddouble d)> pade_minus_8_16 = new(Array.AsReadOnly(new (ddouble c, ddouble)[]{
                ((+1, 0, 0x975B207D17B74782uL, 0xFE3A01B37B421145uL), (+1, 0, 0x8000000000000000uL, 0x0000000000000000uL)),
                ((+1, 0, 0xC3DFA1DF77E95ECAuL, 0x6AED6181C6CFAEC2uL), (+1, 0, 0xA516006444944DF4uL, 0xBBC396D0EBF29769uL)),
                ((+1, -1, 0xED39A19A0A617950uL, 0x82E50CCD389DA24BuL), (+1, -1, 0xC76F5F6A26DDC8A3uL, 0xC9B8673D9890FD74uL)),
                ((+1, -2, 0xB1A0FC36DF5ED6EAuL, 0x37E38DC9DF999F05uL), (+1, -2, 0x950D18DD91ED169AuL, 0x1AE7BBC34238FA25uL)),
                ((+1, -4, 0xB70B1803903FD88AuL, 0xF103CAA492E987B8uL), (+1, -4, 0x9960C911BBC65FB2uL, 0xC2A89D272E2F7F71uL)),
                ((+1, -6, 0x88A7847017F7E6B7uL, 0xDA32F026350C8B06uL), (+1, -7, 0xE4C6AC61F2B08840uL, 0x78CB82916D98E358uL)),
                ((+1, -9, 0x977F4A9A9D3415B7uL, 0xD2DE0B28AB691159uL), (+1, -10, 0xFD6F669BFD89DEC9uL, 0xD8044176891C2F9CuL)),
                ((+1, -13, 0xFB29B074B38162DDuL, 0xD127B98737C21DA5uL), (+1, -13, 0xD1F94EEA3FE57975uL, 0xA6BBE6CC92BA72F2uL)),
                ((+1, -16, 0x9A6CF63A4DBFF06AuL, 0xA8FDC667334A6D66uL), (+1, -16, 0x810F338CA8C1FF51uL, 0x38930D61477981FCuL)),
                ((+1, -20, 0x894AB4B258C02950uL, 0x2FBD0D969B11A15DuL), (+1, -21, 0xE570CD64B89FC14FuL, 0x8F66129F3315F661uL)),
                ((+1, -25, 0xA770459F387123C6uL, 0x372D2D65B6A0B232uL), (+1, -25, 0x8BE6EE990B5FE4D2uL, 0xD70B703E31E48DAFuL)),
                ((+1, -31, 0xFB5A8EDE13B91B42uL, 0xB1D517B99F55DBEFuL), (+1, -31, 0xD2044CF5301125F0uL, 0x244741F69631219CuL)),
                ((+1, -37, 0xAF7B22B666094A23uL, 0x43E60C2FC7563A0BuL), (+1, -37, 0x929F335C089F325FuL, 0x753E5B4D6385FAE0uL)),
            }));

            private static readonly ReadOnlyCollection<(ddouble c, ddouble d)> pade_minus_16_32 = new(Array.AsReadOnly(new (ddouble c, ddouble)[]{
                ((+1, 0, 0x98F4E09C7D1EA78BuL, 0x5087D0DED3A69F1CuL), (+1, 0, 0x8000000000000000uL, 0x0000000000000000uL)),
                ((+1, -1, 0xCC645398EE2E04F5uL, 0x3B9ABFC2FA4E420AuL), (+1, -1, 0xAAF8102B149335B7uL, 0xB41F9201344A832AuL)),
                ((+1, -3, 0xF5C023C037286356uL, 0x1702E62C84AE3B9FuL), (+1, -3, 0xCD7E11214F62E36BuL, 0x041D11C2AC475F0BuL)),
                ((+1, -5, 0xAF1AA00AAC12457BuL, 0x922FDF8B21E4A011uL), (+1, -5, 0x926106B234947F50uL, 0xBB7044D0350CA266uL)),
                ((+1, -8, 0xA3CAE6A82A1D77FEuL, 0xEEB4ECE82006290EuL), (+1, -8, 0x88E539EDB6B06E47uL, 0xFCE5282925663E05uL)),
                ((+1, -12, 0xD230CD8516664B1BuL, 0x4A8CCA9AA74DACB6uL), (+1, -12, 0xAFA6479CB15E0B13uL, 0x86B67DA4D95118C1uL)),
                ((+1, -16, 0xBB63442A393E8C1CuL, 0xD0EA14AD3079A5F6uL), (+1, -16, 0x9C94849C4B099CE9uL, 0x32F8317754AAF01FuL)),
                ((+1, -21, 0xE53307D68B1D05A9uL, 0xB06002435CA55CBEuL), (+1, -21, 0xBF824716A5569417uL, 0x693B288FB8D3B3B3uL)),
                ((+1, -26, 0xB8096FB64BD34635uL, 0x7CF8B65B8D420E9DuL), (+1, -26, 0x99C54A634F3C9C1EuL, 0x86F800E0F217F0C1uL)),
                ((+1, -32, 0xAF2EDFCBEB02760BuL, 0x19322F854619E293uL), (+1, -32, 0x925F7B20E3AB600BuL, 0xFC8DEECB5D75CAB2uL)),
                ((+1, -39, 0x9618FBDCC8EE89C5uL, 0x89781FCECFF41C9BuL), (+1, -40, 0xFAD36F17FD80176CuL, 0x5613FC67086E4DF1uL)),
            }));
            ...
            private static ddouble MinusValue(ddouble x) {
                ...
                if (x <= 2d) {
                    ...
                    ddouble y = v / ExMath.Pow3d2(x) * Exp(-(2d * x * x * x) / 27d);
