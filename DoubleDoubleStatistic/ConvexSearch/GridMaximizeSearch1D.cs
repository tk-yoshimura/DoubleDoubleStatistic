...
namespace DoubleDoubleStatistic.Optimizer {
    internal class GridMaximizeSearch1D : IConvexSearch<ddouble> {
        ...
        public GridMaximizeSearch1D(Func<ddouble, ddouble> cost_func, (ddouble min, ddouble max) range, int depth, int max_iter) {
        ...
        public void Iteration() {
            ...
            if ((ddouble.Abs(param_min - param_max) <= ddouble.Abs(param_center) * 1e-30) ||
                ...
                searched[position_center] = (param_center, ddouble.BitIncrement(cost_center));
        ...
        public static ddouble Search(Func<ddouble, ddouble> cost_func, (ddouble min, ddouble max) range, int iter) {
            GridMaximizeSearch1D searcher = new(cost_func, range, depth: 100, max_iter: iter);
