...
namespace DoubleDoubleStatisticTest.ContinuousDistributions.LinearityDistribution {
    [TestClass()]
    public class DavisDistributionTests {
        readonly DavisDistribution dist_alpha2mu1sigma1 = new(alpha: 2, mu: 1, sigma: 1);
        readonly DavisDistribution dist_alpha3mu0sigma4 = new(alpha: 3, mu: 0, sigma: 4);
        readonly DavisDistribution dist_alpha4mu0sigma4 = new(alpha: 4, mu: 0, sigma: 4);
        readonly DavisDistribution dist_alpha5mu0sigma6 = new(alpha: 5, mu: 0, sigma: 6);
        readonly DavisDistribution dist_alpha6mu0sigma8 = new(alpha: 6, mu: 0, sigma: 8);

        DavisDistribution[] Dists => [
            dist_alpha2mu1sigma1,
            dist_alpha3mu0sigma4,
            dist_alpha4mu0sigma4,
            dist_alpha5mu0sigma6,
            dist_alpha6mu0sigma8,
        ];
