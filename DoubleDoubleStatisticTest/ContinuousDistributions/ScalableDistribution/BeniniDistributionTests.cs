...
namespace DoubleDoubleStatisticTest.ContinuousDistributions.ScalableDistribution {
    ...
    public class BeniniDistributionTests {
        readonly BeniniDistribution dist_alpha0beta1theta1 = new(alpha: 0, beta: 1, sigma: 1);
        readonly BeniniDistribution dist_alpha0beta2theta2 = new(alpha: 0, beta: 2, sigma: 1);
        readonly BeniniDistribution dist_alpha1beta1theta1 = new(alpha: 1, beta: 1, sigma: 1);
        readonly BeniniDistribution dist_alpha2beta2theta1 = new(alpha: 2, beta: 2, sigma: 1);
        readonly BeniniDistribution dist_alpha1beta3theta2 = new(alpha: 1, beta: 3, sigma: 2);
        readonly BeniniDistribution dist_alpha2beta1theta2 = new(alpha: 2, beta: 1, sigma: 2);
        readonly BeniniDistribution dist_alpha3beta2theta4 = new(alpha: 3, beta: 2, sigma: 4);
        readonly BeniniDistribution dist_alpha4beta3theta5 = new(alpha: 4, beta: 3, sigma: 5);
        readonly BeniniDistribution dist_alpha5beta1theta7 = new(alpha: 5, beta: 1, sigma: 7);
        readonly BeniniDistribution dist_alpha6beta2theta3 = new(alpha: 6, beta: 2, sigma: 3);

        BeniniDistribution[] Dists => [
            dist_alpha0beta1theta1,
            dist_alpha0beta2theta2,
            dist_alpha1beta1theta1,
            dist_alpha2beta2theta1,
            dist_alpha1beta3theta2,
            dist_alpha2beta1theta2,
            dist_alpha3beta2theta4,
            dist_alpha4beta3theta5,
            dist_alpha5beta1theta7,
            dist_alpha6beta2theta3,
        ];
        ...
        public void PDFExpectedTest() {
            ddouble[] expected_dist_alpha0beta1theta1 = [
            ];
            ddouble[] expected_dist_alpha0beta2theta2 = [
            ];
            ddouble[] expected_dist_alpha1beta1theta1 = [
            ];
            ddouble[] expected_dist_alpha2beta2theta1 = [
            ];
            ddouble[] expected_dist_alpha1beta3theta2 = [
            ];
            ddouble[] expected_dist_alpha2beta1theta2 = [
            ];
            ddouble[] expected_dist_alpha3beta2theta4 = [
            ];

            foreach ((BeniniDistribution dist, ddouble[] expecteds) in new[]{
                (dist_alpha0beta1theta1, expected_dist_alpha0beta1theta1),
                (dist_alpha0beta2theta2, expected_dist_alpha0beta2theta2),
                (dist_alpha1beta1theta1, expected_dist_alpha1beta1theta1),
                (dist_alpha2beta2theta1, expected_dist_alpha2beta2theta1),
                (dist_alpha1beta3theta2, expected_dist_alpha1beta3theta2),
                (dist_alpha2beta1theta2, expected_dist_alpha2beta1theta2),
                (dist_alpha3beta2theta4, expected_dist_alpha3beta2theta4),
            }) {
