...
namespace DoubleDoubleStatisticTest.ConvexSearch {
    [TestClass()]
    public class BisectionMinimizeSearch2DTests {
        [TestMethod()]
        public void SearchTest1() {
            for (int xc = -9; xc <= 9; xc++) {
                for (int yc = -9; yc <= 9; yc++) {
                    ...
                    (ddouble x, ddouble y) = BisectionMinimizeSearch2D.Search(f, ((-1, -1), (1, 1)), 1000);
        ...
        public void SearchTest2() {
            ...
            (ddouble x, ddouble y) = BisectionMinimizeSearch2D.Search(f, ((2, 3), (5, 7)), 1000);
