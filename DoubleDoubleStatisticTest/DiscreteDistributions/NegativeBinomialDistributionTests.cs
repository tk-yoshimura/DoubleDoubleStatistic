...
namespace DoubleDoubleStatisticTest.DiscreteDistributions {
    ...
    public class NegativeBinomialDistributionTests {
        readonly NegativeBinomialDistribution dist_n8p25 = new(n: 8, p: 0.25);
        readonly NegativeBinomialDistribution dist_n6p50 = new(n: 6, p: 0.50);
        readonly NegativeBinomialDistribution dist_n10p875 = new(n: 10, p: 0.875);

        NegativeBinomialDistribution[] Dists => [
            dist_n8p25,
            dist_n6p50,
            dist_n10p875,
        ];
        ...
        public void MeanTest() {
            Assert.AreEqual(24.0, (double)dist_n8p25.Mean, 1e-10);
            Assert.AreEqual(6.0, (double)dist_n6p50.Mean, 1e-10);
            Assert.AreEqual(1.4285714285714286, (double)dist_n10p875.Mean, 1e-10);
        }
        ...
        public void PMFExpectedTest() {
            ...
            foreach ((NegativeBinomialDistribution dist, ddouble[] expecteds) in new[]{
